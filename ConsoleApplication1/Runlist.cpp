...
wsp::Runlist::Runlist(CHAR* pcRunlistStart, UINT64 uStartingVCN, UINT64 uFinalVCN)
...
const wsp::RunlistEntry& wsp::Runlist::at(WORD wIndex) const
{
	return m_pRunlist->at(wIndex);
}

wsp::RunlistEntry& wsp::Runlist::at(WORD wIndex)
{
	return m_pRunlist->at(wIndex);
}

WORD wsp::Runlist::size() const
{
	return m_pRunlist->size();
}

void wsp::Runlist::parseRunlist(CHAR* pcRunlistStart)
{
	CHAR cHeader;
...
void wsp::Runlist::readLength(CHAR** pRunlist, UINT64& uLength, CHAR cBytesNumber)
{
...
void wsp::Runlist::readOffset(CHAR** pRunlist, INT64& lOffset, CHAR cBytesNumber)
{
