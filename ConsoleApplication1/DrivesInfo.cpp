...
#include <iostream>
wsp::DrivesInfo::DrivesInfo(const std::shared_ptr<std::list<PartitionTableEntry>> pDrives)
...
*/
void wsp::DrivesInfo::getDrivesInfo()
{
...
const std::shared_ptr<std::vector<wsp::MFTInfo>> wsp::DrivesInfo::getDrivesMFT() const
{
	return m_pDrivesMFT;
}
