...
wsp::PartitionTableParser::PartitionTableParser()
...
const std::shared_ptr<std::list<wsp::PartitionTableEntry>> wsp::PartitionTableParser::getLogicalDrives() const
{ 
	return m_pLogicalDrives; 
}

void wsp::PartitionTableParser::parse()
{
...
void wsp::PartitionTableParser::parseExetendedPartition(DWORD dwPrimaryExPartitionFirstSec)
{
	CHAR caSector[SECTOR_SIZE];
